...
##temp test
    $did = & python3 ./DoCAStuff.py --mode NewRootCA --basepath $baseP --name "Gamache Trust Root EKUd 2023" --validfrom janOf2018 --validto janOf2048 --keysize 4096 --pathlength 2 --ekus "SERVER_AUTH,OCSP_SIGNING"
    ...
    $did = & python3 ./DoCAStuff.py --mode SignCRL --basepath $baseP --signer "Gamache Trust Root EKUd 2023" --validfrom dtMinusTenMin --validto dtPlusOneYear 
    ...
    $did = & python3 ./DoCAStuff.py --mode NewSubCA --basepath $baseP --name "Gamache Int CA 2023" --signer "Gamache Trust Root EKUd 2023" --validfrom janOf2018 --validto janOf2028 --keysize 2048 --pathlength 1 --ekus "SERVER_AUTH,OCSP_SIGNING"
    $certBack = $did | ConvertFrom-Json
    $intCA = $certBack
    ...
    "badf00d" | Out-File -FilePath "$($certBack.basePath)/revoked.txt"  -Encoding ascii
    "$($baseHTTP)$($certBack.serial).crl" | Out-File -FilePath "$($certBack.basePath)/cdp.txt" -Encoding ascii -NoNewline
    $did = & python3 ./DoCAStuff.py --mode SignCRL --basepath $baseP --signer "Gamache Int CA 2023" --validfrom dtMinusTenMin --validto dtPlusOneYear 
    $crlBack = $did | ConvertFrom-Json
    Copy-Item -Force $crlBack.basePath "$($artifacts)/$($certBack.serial).crl"
    ...
    $did = & python3 ./DoCAStuff.py --mode NewSubCA --basepath $baseP --name "Gamache Online CA 2023" --signer "Gamache Int CA 2023" --validfrom janOf2018 --validto janOf2028 --keysize 2048 --pathlength 0 --ekus "SERVER_AUTH,OCSP_SIGNING" --ncdisallowed "threat.pkilab.markgamache.com"
    $certBack = $did | ConvertFrom-Json
    $intCA = $certBack
    ...
    "badf00d" | Out-File -FilePath "$($certBack.basePath)/revoked.txt"  -Encoding ascii
    "$($baseHTTP)$($certBack.serial).crl" | Out-File -FilePath "$($certBack.basePath)/cdp.txt" -Encoding ascii -NoNewline
    $did = & python3 ./DoCAStuff.py --mode SignCRL --basepath $baseP --signer "Gamache Online CA 2023" --validfrom dtMinusTenMin --validto dtPlusOneYear 
    $crlBack = $did | ConvertFrom-Json
    Copy-Item -Force $crlBack.basePath "$($artifacts)/$($certBack.serial).crl"


     # RadioStar.pkilab.markgamache.com this site has noo issues. 
    $did = & python3 ./DoCAStuff.py --mode NewLeafTLS --basepath $baseP --name "RadioStar.pkilab.markgamache.com" --signer "Gamache Online CA 2023" --validfrom dtMinusTenMin --validto dtPlusOneYear --keysize 2048 
    $did | ConvertFrom-Json

    $did = & python3 ./DoCAStuff.py --mode NewLeafTLS --basepath $baseP --name "threat.pkilab.markgamache.com" --signer "Gamache Online CA 2023" --validfrom dtMinusTenMin --validto dtPlusOneYear --keysize 2048 
    $did | ConvertFrom-Json
